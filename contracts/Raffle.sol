...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
  ...
  VRFCoordinatorV2Interface private immutable i_vrfCordinatorV2;
  ...
  constructor(
    ...
    i_vrfCordinatorV2 = VRFCoordinatorV2Interface(vrfCordinatorV2);
    i_gasLane = gasLane;
  ...
  function requestRandomWinner() external {
    ...
    uint256 requestId = i_vrfCordinatorV2.requestRandomWords(
      i_gasLane,
      i_subscriptionId,
